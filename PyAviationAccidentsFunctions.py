...
#*******************************************************************************************
 #
 #  File Name:  PyAviationAccidentsFunctons.py
 #
 #  File Description:
 #      This Python script, PyAviationAccidentsFunctons, contains generic Python
...
CONSTANT_LOCAL_FILE_NAME \
    = 'PyAviationAccidentsFunctons.py'
    ...
    try:
        ...
        tempString \
            = tempString \
                .replace \
                    ('off Alaska',  
                     '320 km (198.8 mls) SE of Anchorage, AK (United States of America)')
        ...
        if 'near Hawaii' == tempString.strip():
            ...
            tempString \
                = 'near Honolulu, HI, (United States of America)'     
...
def ReturnLocationDictionaryLocation \
    ...
    try:
        ...
        log_subroutine \
            .PrintAndLogWriteText \
                (f'The function, ReturnLocationDictionaryLocation, '
                 + f'in source file, {CONSTANT_LOCAL_FILE_NAME}, '
...
#*******************************************************************************************
 #
 #  Function Name:  CalculateNewGeoCoordinates
 #
 #  Function Description:
...
def CalculateNewGeoCoordinates \
        (latitudeFloat, 
         longitudeFloat, 
         distanceFloat, 
         bearingDegreesFloat, 
    ...
    try:
        ...
        log_subroutine \
            .PrintAndLogWriteText \
                (f'The function, CalculateNewGeoCoordinates, '
                 + f'in source file, {CONSTANT_LOCAL_FILE_NAME}, '
